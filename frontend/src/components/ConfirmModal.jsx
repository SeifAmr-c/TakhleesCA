...
function ConfirmModal({
  ...
  /* In success mode we use a slightly more affirming title unless the
     caller passed something more specific. The original title still
     wins so callers can keep their own copy. */
      ...
      >
        {isSuccess ? (
          /* Success layout — centered column with the check glyph on top
             so the affirmation reads as a single visual beat. */
          <div
            style={{
              display: "flex",
